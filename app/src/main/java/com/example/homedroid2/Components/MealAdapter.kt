...
class MealAdapter(private val onBookClick: (Meal) -> Unit, diffCallback: DiffUtil.ItemCallback<Meal>) :
    ...
    override fun onBindViewHolder(holder: BooksViewHolder, position: Int) {
        holder.bindBooks(getItem(position)!!, onBookClick)
    }
